...
export default function App() {
  ...
  useEffect(() => {
    try {
      const r = localStorage.getItem("yt_projects");
      if (r) setProjects(JSON.parse(r));
      const c = localStorage.getItem("yt_checks");
  ...
  function saveProjects(p) {
    setProjects(p);
    try { localStorage.setItem("yt_projects", JSON.stringify(p)); } catch {}
  }

  function saveChecks(c) {
    setChecks(c);
    try { localStorage.setItem("yt_checks", JSON.stringify(c)); } catch {}
  }
